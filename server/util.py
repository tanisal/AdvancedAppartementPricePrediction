...
def load_saved_artifacts_shumen():
    ...
    with open('./artifacts/columns_shumen.json','r',encoding='utf-8') as f:
...
def load_saved_artifacts_plovdiv():
    ...
    with open('./artifacts/columns_plovdiv.json','r',encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    print(get_predict_price_shumen('херсон',58,3,9,'тухла'))

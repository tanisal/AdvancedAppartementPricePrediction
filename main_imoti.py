...
#     driver.get(r'https://www.imot.bg/pcgi/imot.cgi?act=3&slink=81fllq&f1=1')
...
#         url =r'https://www.imot.bg/pcgi/imot.cgi?act=3&slink=81fllq&f1={}'.format(page)
#         driver.get(url)
...
# df.to_csv(r"imotibg.csv",index=False)

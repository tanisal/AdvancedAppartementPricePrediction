...
df4.drop(df4[(df4["price"] > 400000)].index, inplace=True)

df4[(df4["price"] < 110000) & (df4["m2"] > 130)]
df4[(df4["price"] < 130000) & (df4["m2"] > 150)]

df4.drop([503, 477], axis=0, inplace=True)
...
# We split the dependant from the independant variables
...
dump(elasticnet_model, "sofia_appartament_price_model_elasticnet.joblib")
dump(lasso_model, "sofia_appartament_price_model_lasso.joblib")
dump(ridge_model, "sofia_appartament_price_model_ridge.joblib")
dump(gbr_model, "sofia_appartament_price_model_gbr.joblib")
dump(xgboost_model, "sofia_appartament_price_model_xgboost.joblib")
dump(stack_model, "sofia_appartament_price_model_stack.joblib")
